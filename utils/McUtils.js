...
export class McUtils {
     ...
     * @returns [x, y, z] | null
     */
    static rayTraceBlock(maxDistance = 50, partialTicks = 1, forceSneak = false, yaw = Player.getYaw(), pitch = Player.getPitch()) {
    ...
    static sendUseItem() {
        mc.field_71442_b.func_78769_a(Player.getPlayer(), World.getWorld(), Player.getPlayer().field_71071_by.func_70448_g())
    }
    ...
    static sendPacketNoEvent(packet) {
        mc.func_147114_u().func_147298_b().func_179288_a(packet, null, new Array(0));
    }
    ...
    static getClosesetMOPOnBlock(eyePos, blockPos, world) {
        const aabb = world.func_180495_p(blockPos).func_177230_c().func_180646_a(world, blockPos);
    ...
    static getClosesetMOPOnEntity(eyePos, entity) {
        ...
        const aabb = entity.func_174813_aQ().func_72314_b(collisionBorderSize, collisionBorderSize, collisionBorderSize);
